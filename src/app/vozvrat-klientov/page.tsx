...
export const metadata: Metadata = {
  ...
  description:
    "ИИ-ассистент сам возвращает замолчавших клиентов: догоняющие сообщения с откликом до 40%, напоминания и подписка на снижение цены в MAX. Без спама.",
  keywords: [
          ...
          <div className="mx-auto max-w-4xl px-5 py-14 sm:px-6 lg:px-8 lg:py-16">
            ...
            <p className="mx-auto mt-6 flex max-w-2xl items-start justify-center gap-1.5 text-center text-xs text-muted">
              ...
              <span>
                ...
                >
                  Как подключить ассистента в MAX
                </Link>
                .
              </span>
            </p>
