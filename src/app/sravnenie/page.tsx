...
export const metadata: Metadata = {
  ...
  description:
    "Четыре способа автоматизировать подбор туров: ИИ-ассистент с базой Tourvisor, модуль поиска, конструктор ботов, разработка на заказ. Одна таблица, цены на сентябрь 2026.",
  keywords: [
