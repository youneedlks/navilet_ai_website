...
export const metadata: Metadata = {
  ...
  description:
    "Кейс МГП × «Навылет! AI»: как Сеть магазинов горящих путёвок (27 лет, 396 офисов) первой в России внедрила ИИ-ассистента в работу с клиентами.",
  keywords: [
      ...
      <main>
        ...
        <article>
          ...
          <section className="mx-auto max-w-3xl px-5 py-14 sm:px-6 lg:px-8 lg:py-16">
            ...
            <p className="mt-5 text-base text-body">
              Проект «Навылет! AI» получил официальную поддержку Комитета
              ТПП РФ по предпринимательству в сфере туризма: вице-президент
              Российского союза туриндустрии Юрий Александрович Барзыкин
              рекомендовал проект профильным фондам, акселераторам и партнёрам
              индустрии (письмо № 49К/0009 от 19.08.2025). Партнёрство с МГП
              стало одним из ключевых аргументов такой оценки — подробнее{" "}
              <Link
                href="/o-komande"
                className="font-semibold text-accent underline decoration-accent/30 underline-offset-2 hover:decoration-accent"
              >
                о компании и признании индустрии
              </Link>
              .
            </p>
            <div className="mt-6">
