...
export const metadata: Metadata = {
  ...
  description:
    "Лиды для турагентства по 219–540 ₽ вместо 1 500–5 000 ₽ из рекламы: ИИ-ассистент превращает трафик сайта в заявки с контактом. От 990 ₽/мес, месяц бесплатно.",
  keywords: [
        ...
        <section className="relative overflow-hidden bg-white">
          ...
          <div className="relative mx-auto max-w-4xl px-5 pt-28 pb-12 text-center sm:px-6 sm:pt-32 lg:px-8">
            ...
            <p className="mt-3 text-xs text-muted">
              Данные сети «Навылет! AI»: 30+ ассистентов на сайтах партнёров и в мессенджерах,
